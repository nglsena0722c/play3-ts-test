const Item = ({ position }: { position?: string }) => {
    return <div className="bg-[#F6F9FF] relative border-[3px] border-[#D8E1E9] rounded-[16px] aspect-square flex justify-center items-center item-shadow overflow-hidden">
